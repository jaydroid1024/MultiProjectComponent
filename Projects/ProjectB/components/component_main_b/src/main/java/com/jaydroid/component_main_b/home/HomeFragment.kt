package com.jaydroid.component_main_b.home
...
import com.jaydroid.component_main_b.home.adapter.HomeRecyclerAdapter
import com.jaydroid.component_main_b.home.bean.Article
import com.jaydroid.component_main_b.home.contract.HomeContract
import com.jaydroid.conponent_base.base.mvp.BaseMVPFragment
import com.jaydroid.conponent_base.widget.LinearItemDecoration
...
class HomeFragment : BaseMVPFragment<HomeContract.View, HomePresenter>(), HomeContract.View {
    ...
    override fun onBanner(list: List<com.jaydroid.conponent_base.network.bean.wan.Banner>?) {
